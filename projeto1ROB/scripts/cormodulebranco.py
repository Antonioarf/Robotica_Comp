...
def identifica_cor(frame):
    ...
    # maskverde = cv2.inRange(frame_hsv,cor1,cor2)
    # segmentado_cor1 = cv2.inRange(frame_hsv,cor1, cor2)

    #VERMELHO
    cor_menor = np.array([0, 150, 50])
    cor_maior = np.array([5, 255, 255])
    segmentado_cor1 = cv2.inRange(frame_hsv, cor_menor, cor_maior)
    cor_menor = np.array([175, 150, 50])
    cor_maior = np.array([180, 255, 255])
    segmentado_cor1 += cv2.inRange(frame_hsv, cor_menor, cor_maior)
    
    segmentado_cor= cv2.blur(segmentado_cor1, (3,3))
    ...
    if not maior_contorno is None :
        cv2.drawContours(frame, [maior_contorno], -1, [0, 255,], 5)
...
<<<<<<< HEAD
    # cv2.imshow('seg_teste', segmentado_cor)
=======
    cv2.imshow('seg_teste', segmentado_cor)
>>>>>>> 86ad745e593afe00fbe1b85700f2902ae2475606
    cv2.waitKey(1)
