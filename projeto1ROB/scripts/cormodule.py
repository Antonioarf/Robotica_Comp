...
def identifica_cor(frame):
    ...
    # cor_maior = np.array([180, 5, 255])
    # print("CHEGUEIII AQUIIiiiiiiiiiiiiiiiiiiiiiiii")
    #cor1, cor2 = aux.ranges(cor_rgb)
    #mask_coke = cv2.inRange(frame_hsv, cor_menor, cor_maior)
    # maskverde = cv2.inRange(frame_hsv, cor_menor, cor_maior)
    # segmentado_cor= cv2.blur(maskverde, (3,3))
    #COR AMARELA
    cor_rgb = "#ffff00"
    cor1, cor2 = aux.ranges(cor_rgb)
